...
const ExperimenterLog = () => {
  ...
  return (
    ...
    Hi {experimentLog.first_name}, here are your experiment observations: 
    <br></br> <br></br>
    </h2>

    {/*Display Experiment Groups > Experiment Sub Groups > Experiments > Observations we have data for*/}
    {experimentLog.experiment_groups.map( (item) => (
      <ExperimentGroup 
